...
public class QuitarProductoraPanel extends GeneralPanel {

	private static final long serialVersionUID = 1L;

	private static QuitarProductoraPanel instance;
	private Panel_Main_Pelicula parent;
	JTextField idPeliculaField, idProductoraField;

	public QuitarProductoraPanel() {
		initGUI();
	}
	...
	private void initGUI() {
		...
		JLabel titleLbl = new JLabel("QUITAR PRODUCTORA");
		...
		annadirBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (validation()) {
					Context request = new Context(ContextEnum.QUITARPRODUCTORA,
							new Pair(Integer.parseInt(idProductoraField.getText()), Integer.parseInt(idPeliculaField.getText())));
	...
	public static QuitarProductoraPanel getInstance() {
		if (instance == null) {
			instance = new QuitarProductoraPanel();
		}
		return instance;
	}
	...
	public void update(Object o) {
		if (hasError(o)) {
			...
			JOptionPane.showMessageDialog(parent, "Se ha eliminado la asociacion con exito");
			clear();
		}
	}
