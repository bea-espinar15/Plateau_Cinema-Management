...
public class BajaPasePanel extends GeneralPanel {

	private static final long serialVersionUID = 1L;
	
	private static BajaPasePanel instance;
	private Panel_Main_Pase parent;
    private JTextField idField;
    private Integer id;
    
	public BajaPasePanel()
	{
		initGUI();
	}
	
	public static BajaPasePanel getInstance() {
		if(instance == null)
		{
			instance = new BajaPasePanel();
		}
		return instance;
	}
	...
	public void update(Object o) {
		if (hasError(o)) {
			...
			String mensaje = "El pase se ha dado de baja correctamente";
    ...
    private void initGUI() {
		...
		JLabel titleLbl = new JLabel("BAJA PASE");
		...
		mostrarBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				if(validation()){
					Context request = new Context(ContextEnum.BAJAPASE, Integer.parseInt(idField.getText()));
